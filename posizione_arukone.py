...
class State(Enum):
    ...
    MOVE_PRINGLES_TO_INTERMEDIATE_1 = 18
    MOVE_PRINGLES_TO_INTERMEDIATE_2 = 19
...
class KinematicPlanner(Node):
    ...
    def command_callback(self, msg):
        ...
        if msg.data == State.MOVE_TO_POSE_1.value:
            ...
            self.calculate_pose_with_offset_state(1, offset_x=-0.075, offset_y=0.10, offset_z=-0.3)
        ...
        elif msg.data == State.MOVE_PRINGLES_TO_INTERMEDIATE_1.value:
            self.get_logger().info("Comando ricevuto: MOVE_PRINGLES_TO_INTERMEDIATE_1")
            self.current_state = State.MOVE_PRINGLES_TO_INTERMEDIATE_1
            self.calculate_pose_with_offset_state(1, offset_x=-0.06, offset_y=0.1, offset_z=0.1)
        elif msg.data == State.MOVE_PRINGLES_TO_INTERMEDIATE_2.value:
            self.get_logger().info("Comando ricevuto: MOVE_PRINGLES_TO_INTERMEDIATE_2")
            self.current_state = State.MOVE_PRINGLES_TO_INTERMEDIATE_2
            self.calculate_pose_with_offset_state(1, offset_x=-0.06, offset_y=0.05, offset_z=0.1)
