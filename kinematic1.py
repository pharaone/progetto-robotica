...
from roboticstoolbox import DHRobot, RevoluteDH, ERobot  # ← aggiunto ERobot
...
class TaskPlanner(Node):
    def __init__(self):
        ...
        # Subscribe a pose e tipo di task
    ...
    def plan_and_send_arm_trajectory(self):
        ...
        # Costruzione messaggio JointTrajectory
