...
class State(Enum):
    ...
    MOVE_UP_PRINGLES = 17
    MOVE_INTERMEDIATE_COLA = 18
    MOVE_INTERMEDIATE_PRINGLES = 19
    MOVE_INTERMEDIATE_POSE_COLA = 20
    MOVE_INTERMEDIATE_POSE_PRINGLES = 21
...
class RobotStateMachineNode(Node):
    ...
    def loop(self):         
        if self.stato_corrente != self.ultimo_stato:
            ...
            if self.stato_corrente == State.MOVE_TO_POSE_1:
                self.move_to_pose_1()
            elif self.stato_corrente == State.MOVE_INTERMEDIATE_POSE_COLA:
                self.move_intermediate_pose_cola()
                ...
                self.move_up_cola()
            elif self.stato_corrente == State.MOVE_INTERMEDIATE_COLA:
                self.move_intermediate_cola()
                ...
                self.grip_object_2()
            elif self.stato_corrente == State.MOVE_INTERMEDIATE_POSE_PRINGLES:
                self.move_intermediate_pose_pringles()
            elif self.stato_corrente == State.MOVE_UP_PRINGLES:
                self.move_up_pringles()
            elif self.stato_corrente == State.MOVE_INTERMEDIATE_PRINGLES:
                self.move_intermediate_pringles()
    ...
    def completed_command_callback(self, msg):
        ...
        if msg.data == State.WAITING_FOR_ARUCO.value:
            ...
            self.stato_corrente = State.MOVE_INTERMEDIATE_POSE_COLA
        elif msg.data == State.MOVE_INTERMEDIATE_POSE_COLA.value:
            ...
            self.stato_corrente = State.MOVE_INTERMEDIATE_COLA
        elif msg.data == State.MOVE_INTERMEDIATE_COLA.value:
            ...
            self.stato_corrente = State.MOVE_INTERMEDIATE_POSE_PRINGLES
        elif msg.data == State.MOVE_INTERMEDIATE_POSE_PRINGLES.value:
            self.stato_corrente = State.MOVE_UP_PRINGLES
        elif msg.data == State.MOVE_UP_PRINGLES.value:
            self.stato_corrente = State.MOVE_INTERMEDIATE_PRINGLES
        elif msg.data == State.MOVE_INTERMEDIATE_PRINGLES.value:
    ...
    def move_intermediate_pose_cola(self):
        self.get_logger().info("Muovo verso la posa intermedia (cola).")
        msg = Int32()
        msg.data = State.MOVE_INTERMEDIATE_POSE_COLA.value
        self.publisher.publish(msg)
    ...
    def move_intermediate_cola(self):
        self.get_logger().info("Muovo la coca verso lo stato intermedio.")
        msg = Int32()
        msg.data = State.MOVE_INTERMEDIATE_COLA.value
        self.publisher.publish(msg)
    ...
    def move_intermediate_pose_pringles(self):
        self.get_logger().info("Muovo verso la posa intermedia (pringles).")
        msg = Int32()
        msg.data = State.MOVE_INTERMEDIATE_POSE_PRINGLES.value
        self.publisher.publish(msg)
    ...
    def move_intermediate_pringles(self):
        self.get_logger().info("Muovo le patatine verso lo stato intermedio.")
        msg = Int32()
        msg.data = State.MOVE_INTERMEDIATE_PRINGLES.value
        self.publisher.publish(msg)
